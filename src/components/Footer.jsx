...
const Footer = () => {
  return (
    <section className="bg-[#12082D] py-16 w-full blue-500">
        ...
        <ul className="leading-6">
          ...
          <div className="relative w-full">
            <input
              ...
              className="border-gray-300 p-2 pr-[120px] pl-4 border rounded-md w-full h-[50px] text-black"
            />
            <button className="top-1/2 right-[5px] absolute bg-[#4C4989] px-4 rounded-md h-[40px] text-white transform -translate-y-1/2">
              Subscribe
            </button>
          </div>
        </ul>
      ...
      <p className="text-right col-span-1 md:col-span-6 mt-10 w-full text-[14px] text-white whitespace-nowrap container">

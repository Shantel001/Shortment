...
import tall from "../assets/tall.svg";
...
const Favorite = () => {
  ...
  return (
    <section>
      ...
      <div className="flex flex-col items-center px-4 pt-[95px] md:pb-[50px] text-black text-center">
      ...
      <div className="flex-col flex items-center justify-center mt-[50px] mb-[50px] md:mt-[190px] md:mb-[300px]">
        <div>
          <img
            src={tall}
            alt="image"
            className="md:w-[290px] md:h-[424px] w-[200px] h-[370px]"
          />
        </div>
        <div>
          <p className="mt-[15px] text-[14px] text-[#2B3F58] md:text-[24px] font-medium md:mt-[40px]">
            No apartments in your favorites list yet
          </p>
        </div>
      </div>

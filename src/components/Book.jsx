  ...
  return (
    <section className="flex flex-col items-center">
      ...
      <div className="flex flex-col items-center px-4 pt-[10px] pb-[50px] text-black text-center ">
        ...
        <h1 className="pt-[25px] md:pt-[73px] font-semibold text-[#2B3F58] text-[16px] md:text-[24px] leading-12 mt-[54px] md:mt-[84px]">
          Summary and Payment
        </h1>
        <p className="pt-[5px] font-light text-[#2B3F58] text-[12px] md:text-[20px]">
          We want to assure you that your financial security is of utmost
          importance to us
        </p>
      </div>
      ...
      <div className="border-2 flex flex-col justify-center w-full md:w-[50%] mb-[72px] mt-[30px] px-[30px] py-[40px] rounded-[20px] bg-white relative">
        ...
        <div className="flex gap-[10px] justify-center items-center text-[14px] mb-[42px]">
          <input type="checkbox" name="agreement" id="paypal" />
          <label htmlFor="paypal" className="">
            By clicking this button, you agree to the Terms of use and Privacy
            Policy. I commit to paying the entire amount upon the host's

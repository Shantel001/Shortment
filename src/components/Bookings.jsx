      ...
      "
            >
                <div className="container flex justify-between items-center sm:gap-[15px]">
                    <Link to="/">
                        <img src={logos} alt="logo" className=":hidden md:block" />
                    </Link>
                    ...
                    <div className="flex items-center gap-[18px]">
                        ...
                        <div className="relative inline-flex it ems-center gap-[3px] border p-2 rounded-[90px] bg-[#4C4989] border-[#4C4989] md:h-[55px] h-[30px] md:w-[120px] w-[100px]">
                            <label
                                htmlFor="reserve"
            ...
            <div className="grid grid-cols-1 md:flex justify-center items-center container md:gap-[20px]">
                <div className="border p-[20px] ml-[15px] mr-[25px] m-[15px] rounded-[20px] md:w-[684px] md:h-[180px] w-[390px] h-[192px] bg-[#4C4989] flex justify-center flex-col">
                    <h1 className="text-white mb-[15px] pr-[10px] font-semibold text-[13px] md:text-[15px] md:w-[300px] md:h-[30px] mt-[25px] w-[262px] h-[21px]">
                        Welcome to Shortment, Juwon Craig
                    </h1>
                    <p className="text-white font-normal mb-[15px] text-[12px] pr-[50px] w-[374px] h-[30px]">
                        We trust you enjoyed a truly exceptional stay in
                        <br /> our serviced apartment.
                    </p>
                    <button className="border bg-white h-[48px] w-[215px] rounded-[10px] pl-[39px] pr-[39px] pt-[13px] pb-[13px] text-[12px] mb-[46px] font-semibold text-[#2B3F58]">
                        Give us a feedback
                    </button>
                </div>
                <div className="border  w-[390px] h-[192px] ml-[15px] mr-[25px] md:m-[15px] md:h-[180px] md:w-[400px] rounded-[20px] bg-white flex justify-center flex-col ">
                    <h1 className="text-[#4C4989] text-[20px] font-bold w-[341px] h-[30px] pr-[39px] pl-[20px] pt-[20px]">
                        Account Information
                    </h1>
                    <p className="text-[#2B3F58CC] text-[11.5px] font-normal w-[341px] h-[42px] pt-[18px] pb-[18px] pr-[39px] pl-[20px]">
                        Facilitate Payments: Easily manage and process
                        <br /> your payments for services or products.
                    </p>
                    <button className="border rounded-[10px] w-[131px] h-[50px] bg-[#4C4989] flex text-[12px] pt-[13px] pb-[13px]  text-white justify-center items-center gap-[5px] mt-[18px] mb-[49px] ml-[20px] mr-[249px]">
                        <img src={bank} alt="icon" className="" />
                        Add Bank
                    </button>
                </div>
            </div>
